...
def main():
    ...
    for gen in range(1, args.iters+1):
        ...
        # compute negative spatio-temporal entropy
        for i in range(args.pop):
            ...
            rewards[i] = -compute_st_entropy_arr(arr, args.patches_per_dim)

        # store and train critic
        ...
        # visualize first 10 improved trajectories
